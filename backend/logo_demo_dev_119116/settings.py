"""
Django settings for logo_demo_dev_119116 project.
...
ROOT_URLCONF = 'logo_demo_dev_119116.urls'
...
WSGI_APPLICATION = 'logo_demo_dev_119116.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "logo_demo_dev_119116 API",
    "DESCRIPTION": "API documentation for logo_demo_dev_119116 App",
    "VERSION": "v1",
}
